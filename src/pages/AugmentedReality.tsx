...
const scenes = [
  ...
  { id: "lab", name: "Laboratório", desc: "Ambiente de laboratório científico", emoji: "🔬", category: "" },
  { id: "solar", name: "Sistema Solar", desc: "Visualize planetas e órbitas", emoji: "🪐", category: "" },
  { id: "pulsar", name: "Pulsar 3D", desc: "Simulação interativa de uma estrela de nêutrons", emoji: "✨", category: "pulsar" },
];
          ...
          {scenes.map((scene) => (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                {scene.category === "pulsar" && (
                  <span className="text-[10px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded bg-purple-500/20 text-purple-400 border border-purple-500/30">
                    Pulsar
                  </span>
                )}
              </div>
          ...
          <CardContent className="p-0">
            <div className="h-[500px] w-full bg-gradient-to-b from-muted/30 to-muted/10 rounded-xl">
              {activeScene === "pulsar" ? (
                <iframe
                  key="pulsar"
                  src="/pulsar-3D/index.html"
                  title="Pulsar 3D Simulation"
                ...
                <Canvas
                  camera={{
                    position: activeScene === "solar" ? [0, 5, 12] : activeScene === "lab" ? [5, 2, 8] : [5, 4, 5],
                    fov: activeScene === "lab" ? 40 : 50,
                  }}
                  key={activeScene}
                >
