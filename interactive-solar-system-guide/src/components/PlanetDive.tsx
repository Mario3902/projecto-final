...
export default function PlanetDive({ planet, showSun, onClose }: PlanetDiveProps) {
  ...
  if (showSun) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center animate-zoomDive" style={{ background: "radial-gradient(circle at center, rgba(40,20,0,0.95), rgba(2,0,16,0.98))" }}>
        {/* Sun ambient glow */}
        ...
        <button onClick={onClose}
          className="absolute top-6 left-6 z-50 flex items-center gap-2 px-4 py-2.5 glass rounded-full text-white/80 hover:text-white hover:bg-white/10 transition-all cursor-pointer text-sm font-medium">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16 max-w-6xl w-full px-6 max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex-shrink-0 animate-fadeIn">
            <div className="relative">
              <div className="w-48 h-48 md:w-64 md:h-64 rounded-full relative" style={{
                ...
                <div className="absolute inset-2 rounded-full planet-3d opacity-40" style={{
              ...
              <div className="mt-8 flex flex-col gap-2">
                {SUN_DATA.layers.map((layer, i) => (
                  <div key={i} className="flex items-center gap-3 glass rounded-lg px-3 py-2 animate-fadeInUp" style={{ animationDelay: `${i * 0.1}s` }}>
          ...
          {/* Sun Info */}
          <div className="flex-1 max-w-xl animate-slideInRight">
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              {Object.entries(SUN_DATA.facts).map(([key, value], i) => {
                ...
                return (
                  <div key={key} className="glass rounded-xl p-3 animate-fadeInUp" style={{ animationDelay: `${i * 0.08}s` }}>
            ...
            <div className="glass rounded-xl p-4" style={{ borderColor: "rgba(255,170,0,0.2)" }}>
  ...
  return (
    <div className="fixed inset-0 z-50 animate-zoomDive" style={{
      ...
      <div className="absolute top-6 left-1/2 -translate-x-1/2 z-40 text-center">
        <h1 className="text-3xl md:text-4xl font-bold animate-fadeIn" style={{ color: planet.color, textShadow: `0 0 30px ${planet.color}50` }}>
          {planet.namePt}
        </h1>
      ...
      <div className="flex flex-col lg:flex-row h-full pt-20 pb-4 px-4 lg:px-8 gap-6 overflow-hidden">
        ...
        <div className="flex-shrink-0 flex flex-col items-center justify-center lg:w-[380px]">
          <div className="relative animate-fadeIn">
            ...
            {planet.hasAtmosphere && (
              <div className="absolute rounded-full atmosphere-glow" style={{
                inset: "-20px",
                background: `radial-gradient(circle, ${planet.atmosphereColor}, transparent 60%)`,
              }} />
            )}
            {/* Planet */}
            <div className="w-48 h-48 md:w-60 md:h-60 rounded-full relative overflow-hidden animate-float" style={{
              background: planet.texture,
              boxShadow: `0 0 40px ${planet.color}40, 0 0 80px ${planet.color}20, inset -20px -15px 40px rgba(0,0,0,0.5)`,
            }}>
              {/* Rotating surface */}
              <div className="absolute inset-0 rounded-full planet-3d" style={{
          ...
          <div className="mt-6 grid grid-cols-2 gap-2 w-full max-w-[280px]">
            {[
              ...
              <div key={i} className="glass rounded-lg px-3 py-2 text-center animate-fadeInUp" style={{ animationDelay: `${0.3 + i * 0.1}s` }}>
        ...
        <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`px-3 py-2 rounded-lg text-xs font-medium transition-all cursor-pointer border ${
                  activeTab === tab.id ? "tab-active" : "border-transparent text-gray-400 hover:text-white hover:bg-white/5"
                }`}
              >
                {tab.icon} {tab.label}
              </button>
          ...
          {/* Tab content */}
          <div className="flex-1 overflow-y-auto pr-2 animate-fadeIn" key={activeTab}>
            {activeTab === "overview" && (
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {Object.entries(planet.facts).map(([key, value], i) => {
                    ...
                    return (
                      <div key={key} className="glass rounded-xl p-3 animate-fadeInUp hover:bg-white/5 transition-colors" style={{ animationDelay: `${i * 0.06}s` }}>
                ...
                <div className="glass rounded-xl p-4" style={{ borderColor: `${planet.color}25` }}>
              ...
              <div className="space-y-6">
                  ...
                  <div className="relative" style={{ width: "240px", height: "240px" }}>
                    {[...planet.layers].reverse().map((layer, i) => {
                      ...
                      return (
                        <div
                          key={i}
                          className="absolute rounded-full layer-ring cursor-pointer flex items-center justify-center"
                          style={{
                            width: `${size}px`,
                            height: `${size}px`,
                            left: `${120 - size / 2}px`,
                ...
                <div className="space-y-2">
                  {planet.layers.map((layer, i) => (
                    <div
                      key={i}
                      className={`glass rounded-xl p-3 transition-all cursor-pointer ${hoveredLayer === i ? "ring-1 bg-white/5" : ""}`}
            ...
            {activeTab === "surface" && (
              <div className="space-y-4">
                ...
                {planet.surfaceFeatures.map((feature, i) => (
                  <div
                    key={i}
                    className="glass rounded-xl overflow-hidden cursor-pointer transition-all hover:bg-white/5 animate-fadeInUp"
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="w-full bg-gray-800 rounded-full h-2">
                        <div className="h-2 rounded-full transition-all duration-1000 size-comparison-bar" style={{
                ...
                <div className="glass rounded-xl p-5">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <div className="w-full bg-gray-800 rounded-full h-3">
                        <div className="h-3 rounded-full size-comparison-bar" style={{
