...
export default function SolarSystem({ onPlanetClick, onSunClick, isPaused, zoomedPlanet }: SolarSystemProps) {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="absolute rounded-full pointer-events-none solar-atmosphere-glow"
        style={{
      ...
      >
        ...
        >
          {/* Sun surface texture */}
          <div
            className="absolute inset-1 rounded-full opacity-40 solar-planet-3d"
            style={{
        ...
        return (
          ...
          >
            ...
            {planet.hasAtmosphere && (
              <div
                className="absolute rounded-full solar-atmosphere-glow"
                style={{
            ...
            >
              {/* Rotating surface */}
              <div
                className="absolute inset-0 rounded-full solar-planet-3d opacity-30"
                style={{
