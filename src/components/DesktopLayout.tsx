...
import {
    BarChart3, Compass, CheckSquare, Sparkles, Brain, MessageCircle, LogOut, Menu, View, BookOpen, Bot, Globe,
} from "lucide-react";
...
const navItems = [
    ...
    { title: "Sistema Solar", icon: Globe, path: "/dashboard/sistema-solar" },
];

/**
 * DesktopLayout – layout clássico com sidebar, usado exclusivamente nas
 * páginas que requerem ambiente desktop (Sala IA, Ambientes 3D).
 */
