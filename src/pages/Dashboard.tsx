      ...
      <div className="max-w-md mx-auto w-full px-5 py-6">
        ...
        <div className="flex items-center justify-between mb-6 mt-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[#4ade80] text-[10px] font-black tracking-[0.2em] uppercase mb-0.5">BEM-VINDO</p>
              <h1 className="text-2xl font-bold text-white m-0">Olá, {userName}!</h1>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-1 bg-[#141e16] border border-slate-800 px-2.5 py-1.5 rounded-full">
              <span className="text-sm">🪙</span>
              <span className="text-xs font-bold text-yellow-400">{cauris}</span>
            </div>
            <div className="flex items-center gap-0.5 bg-[#141e16] border border-slate-800 px-2.5 py-1.5 rounded-full">
              {isGodMode ? (
        ...
        {/* ── XP + Stats card ── */}
        <div className="bg-[#141e16] border border-[#254238]/60 rounded-3xl p-5 mb-5 relative overflow-hidden shadow-lg">
          <div className="absolute top-0 right-0 w-32 h-32 bg-[#4ade80]/5 rounded-bl-full -mr-8 -mt-8" />
          ...
          <div className="relative z-10 mb-4">
            ...
            <div className="h-2.5 w-full bg-[#0e1710] rounded-full overflow-hidden">
              <div className="h-full bg-[#4ade80] transition-all duration-300" style={{ width: `${xpProgress}%` }} />
            </div>
          </div>
          {/* Mini stats row */}
          <div className="grid grid-cols-3 gap-2 pt-3 border-t border-[#254238]/40">
            ...
            <div className="text-center border-x border-[#254238]/40">
        ...
        <button
          ...
          className="w-full text-left bg-[#4ade80] p-5 rounded-3xl shadow-[0_10px_30px_rgba(74,222,128,0.15)] relative overflow-hidden mb-5 transition-transform active:scale-95 group"
        >
          ...
          <div className="relative flex items-center justify-between">
            <div>
              ...
              <h2 className="text-[#0e1710] text-xl font-black leading-tight mb-1">Quiz do Dia</h2>
              <p className="text-[#0e1710]/60 text-xs font-bold">🎯 {quizzesCompleted} feitos hoje</p>
            </div>
            <div className="bg-[#0e1710] text-[#4ade80] font-bold text-sm px-4 py-2.5 rounded-xl shadow-lg flex items-center gap-1 shrink-0">
        ...
        <div className="grid grid-cols-2 gap-3 mb-3">
          ...
          >
            <div className="w-10 h-10 bg-[#1e2e26] rounded-xl flex items-center justify-center mb-3 text-xl group-hover:bg-[#4ade80]/10 transition-colors">🌳</div>
          ...
          <button
            ...
            className="bg-[#141e16] border border-[#254238] p-4 rounded-2xl text-left hover:border-yellow-500/40 transition-colors group"
          >
            <div className="w-10 h-10 bg-[#1e2e26] rounded-xl flex items-center justify-center mb-3 text-xl group-hover:bg-yellow-500/10 transition-colors">🏆</div>
          ...
          <button
            ...
            className="bg-[#141e16] border border-[#254238] p-4 rounded-2xl text-left hover:border-purple-500/40 transition-colors group"
          >
            <div className="w-10 h-10 bg-[#1e2e26] rounded-xl flex items-center justify-center mb-3 text-xl group-hover:bg-purple-500/10 transition-colors">🃏</div>
          ...
          <button
            ...
            className="bg-[#141e16] border border-[#254238] p-4 rounded-2xl text-left hover:border-cyan-500/40 transition-colors group"
          >
            <div className="w-10 h-10 bg-[#1e2e26] rounded-xl flex items-center justify-center mb-3 text-xl group-hover:bg-cyan-500/10 transition-colors">🕸️</div>
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-[#0f1a10] to-[#111a16] border border-[#254238] p-4 rounded-2xl text-left hover:border-[#4ade80]/40 transition-colors group mb-6"
        >
          <div className="flex items-center gap-3">
        ...
        {loadingSuggestions ? (
          <div className="bg-[#141e16] border border-slate-800/60 rounded-2xl p-6 flex flex-col items-center justify-center mb-5">
            <div className="h-6 w-6 border-2 border-[#4ade80] border-t-transparent rounded-full animate-spin mb-3" />
            <p className="text-xs font-bold text-slate-400">A cruzar o teu horário com as provas...</p>
          </div>
        ) : suggestions.length > 0 ? (
          <div className="space-y-3 mb-5">
            {suggestions.map((s, i) => (
              <div key={i} className="bg-[#141e16] border border-slate-800/60 hover:border-[#254238] transition-colors rounded-2xl p-4">
          ...
          <div className="bg-[#141e16] border border-slate-800/60 rounded-2xl p-5 text-center mb-5">
        ...
        <button
          onClick={() => navigate("/dashboard/calendar")}
          className="w-full text-left bg-[#141e16] border border-slate-800/60 p-4 rounded-2xl hover:border-[#4ade80]/40 transition-colors group"
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#1e2e26] border border-slate-700/50 rounded-xl flex items-center justify-center shrink-0 group-hover:bg-[#4ade80]/10 transition-colors">
